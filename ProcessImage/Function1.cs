...
namespace ProcessImage
{
    ...
    public class Function1
    {
        ...
        public async Task<MyPoco> Run([BlobTrigger("testblobs/{name}", Connection = "StorageConnection")]Stream myBlob, string name, ILogger log)
        {
            ...
            string subscriptionKey = "<ask-alex>";
            string endpoint = "<ask-alex>";

            // string READ_TEXT_URL_IMAGE = "http://insight.randomhouse.com/fullpage.do?pContentType=JPG&pName=fullpage&pISBN=9780345534835&pPageID=17";
            string READ_TEXT_URL_IMAGE = $"https://alexwimageprocessing.blob.core.windows.net/testblobs/{name}";
